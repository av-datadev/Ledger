...
story.append(Paragraph("BRICK BOOK", title_style))
story.append(Paragraph("How to open and use the app — Desktop &amp; Android", subtitle_style))
story.append(rule())
story.append(Spacer(1, 0.15 * inch))
story.append(Paragraph(
    "Brick Book is an offline-first expense tracker for the house-building "
...
story.append(Paragraph(
    "Brick Book lives at one web address (URL). This guide uses a "
...
story.append(Paragraph(
    "You do not need to install any software to use Brick Book on a "
...
story.append(numbered([
    ...
    "You'll see the dark navy <b>BRICK BOOK</b> header and the Dashboard. "
    "You're in.",
]))
story.append(Paragraph("Optional: pin it as its own desktop app", h2_style))
story.append(Paragraph(
    "Chrome and Edge can install Brick Book as a standalone app window "
...
story.append(numbered([
    ...
    "Brick Book now opens from your Desktop, Start Menu, or Dock like any "
    "other application.",
]))
story.append(Paragraph(
...
story.append(numbered([
    ...
    "Go to your phone's home screen. You'll see a new <b>Brick Book</b> "
...
def on_page(canvas, doc_):
    ...
    canvas.drawString(0.9 * inch, letter[1] - 0.2 * inch, "BRICK BOOK — USER GUIDE")
